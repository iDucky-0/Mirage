...
public class DiscordPresence extends Module {
    ...
    private final Setting<List<String>> line1Strings = sgLine1.add(new StringListSetting.Builder()
        ...
        .defaultValue("IGN: {player}", "IP: {server}")
    ...
    private final Setting<List<String>> line2Strings = sgLine2.add(new StringListSetting.Builder()
        ...
        .defaultValue("{round(server.tps, 1)} TPS", "Playing on {server.difficulty} difficulty.", "{server.player_count} Players online")
    ...
    public DiscordPresence() {
        super(Categories.MirageClient, "RPC [M]", "Displays Mirage as your presence on Discord.");
    ...
    public void onActivate() {
        DiscordIPC.start(1280837881014911006L, null);
        ...
        currentSmallImage = SmallImage.iducky;
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                ...
                else if (mc.currentScreen instanceof WidgetScreen) rpc.setState("Browsing Mirage's GUI");
